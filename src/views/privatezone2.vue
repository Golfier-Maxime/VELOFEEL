    ...
    <div class=" lg:mx-20 mx-4 text-Grey-Velofeel dark:text-Dark-Grey font-OpenSans">
        ...
        <form enctype="multipart/form-data" @submit.prevent="createVelo2" class="mb-32 mt-16" v-if="Connected">
            ...
            <div>
                ...
                <input class="mx-auto flex justify-center" placeholder="Ici le lien" v-model="velo2.lienProduit" required />
            </div>
            <!-- type velo -->
            <div>
                        ...
                        <div class="flex gap-2 ">
                            <div class="flex flex-col gap-1 justify-center">
                                ...
                                <div>
                                    ...
                                    <input type="text" class="" v-model="velo2.lienProduit" required />
                                </div>
                            </div>
                        </div>
